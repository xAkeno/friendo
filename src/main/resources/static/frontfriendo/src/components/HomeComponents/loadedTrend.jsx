...
const loadedTrend = props => {
  return (
    <ul className="flex flex-col gap-2 border-1 border-gray-300 bg-gray-100 shadow-xs dark:focus:ring-gray-700 dark:bg-gray-800  dark:border-gray-600  dark:hover:bg-gray-700 dark:text-white rounded-[5px] mt-2">
        <li className="p-3">
