...
const loadedFeed = (props) => {
  ...
  return (
    <div className="w-[100%] flex flex-col items-center pr-5 pl-5">
      <div className="w-[75%] bg-[#ffffff] pt-2 pl-4 pb-2 pr-4 flex flex-col gap-3 rounded-md border-gray-500 border-1 dark:focus:ring-gray-700 dark:bg-gray-800  dark:border-gray-600  dark:hover:bg-gray-700 dark:text-white">
