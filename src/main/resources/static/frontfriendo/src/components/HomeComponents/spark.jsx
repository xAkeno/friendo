...
const spark = (props) => {
  ...
  return (
    <div className="w-[100%] p-5 flex justify-center items-center">
        <div className="flex justify-between items-center h-13 border-1 rounded-md border-gray-500 pt-1 pl-2 pb-1 pr-2 w-[75%]  bg-gray-50 dark:focus:ring-gray-700 dark:bg-gray-800  dark:border-gray-600  dark:hover:bg-gray-700 cursor-pointer" onClick={() => {props.updateShow(1)}}>
