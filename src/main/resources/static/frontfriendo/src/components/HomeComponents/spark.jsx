...
const spark = (props) => {
  ...
  return (
    <div className="w-[100%] p-5 flex justify-center items-center">
        <div className="flex justify-between items-center h-13 border-1 rounded-2xl pt-1 pl-2 pb-1 pr-2 w-[75%]  bg-gray-50 dark:focus:ring-gray-700 dark:bg-gray-800  dark:border-gray-600  dark:hover:bg-gray-700 cursor-pointer" onClick={() => {props.updateShow(1)}}>
            <span className="text-black dark:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-user-icon lucide-circle-user"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="10" r="3"/><path d="M7 20.662V19a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v1.662"/></svg>
            </span>
            <button type="submit" >What is on your mind?</button>
