...
const loadedFriendList = (props) => {
  ...
  return (
    <div className="w-[250px] h-auto p-2 border-1 rounded-[10px] mt-3 mb-3 hover:border-gray-400 hover:cursor-pointer" onClick={() => {navigate("/Profile/" + props.username)}}>
        ...
        <div className="flex flex-col">
          ...
          <h1 className="text-gray-300">{props.name}</h1>
        </div>
    </div>
  )
}
